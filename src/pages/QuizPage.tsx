...
const choice: string[][] = [
  ...
  [
    "",
    "2から調べたい数までの整数を並べ，ふるい落とされていない数のうち小さいものから順に，その倍数をふるい落としていき，最後までふるい落とされなかった数を素数として判定するアルゴリズム．",
    "2から調べたい数までの整数を並べ，ふるい落とされていない数のうち大きいものから順に，その約数をふるい落としていき，最後までふるい落とされなかった数を素数として判定するアルゴリズム．",
    "2から調べたい数の各数kに対して，2以上sqrt(k)以下のすべての数について，kの約数が存在するか逐一判定するアルゴリズム．",
